...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_PRINTABLE_RADIUS 75 // mm
    ...
    // Horizontal distance bridged by diagonal push rods when effector is centered.
    #define DELTA_RADIUS 106.5 //default was : 97.0 mm  Get this value from auto calibrate
  #endif

  // height from z=0 to home position
  #define DELTA_HEIGHT 289 //339 get this value from auto calibrate
...
#define Z_MIN_ENDSTOP_INVERTING false // V1 is NO, V2 is NC
